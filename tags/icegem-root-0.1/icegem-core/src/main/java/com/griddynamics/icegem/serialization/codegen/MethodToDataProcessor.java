...
import com.griddynamics.icegem.serialization.codegen.impl.ToDataFieldProcessor;
...
public class MethodToDataProcessor {
    ...
    private String processNotEnum(XClass element) {
        ...
        builder.append("public boolean toData(Object obj, java.io.DataOutput out) throws java.io.IOException {\n")
                ...
                .append(tab("com.griddynamics.icegem.serialization.codegen.MethodFrameCounter.enterFrame();\n")) //todo: analize exist MethodFrameCounter.class in runtime
        ...
        builder.append(tab("com.griddynamics.icegem.serialization.codegen.MethodFrameCounter.exitFrame();\n"));
